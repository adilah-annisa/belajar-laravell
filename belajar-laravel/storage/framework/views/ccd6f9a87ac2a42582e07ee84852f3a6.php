...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <img src="<?php echo e(asset('assets/images/LOGO GARUDA.jpg')); ?>" alt="logo" class="navbar-logo">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('question.store')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                               ...
                               <textarea class="form-control" rows="4" name="pertanyaan"><?php echo e(old('pertanyaan')); ?></textarea>
                            </div>
...
<?php /**PATH C:\laragon\www\BPF1_Adilah\belajar-laravel\resources\views/home.blade.php ENDPATH**/ ?>