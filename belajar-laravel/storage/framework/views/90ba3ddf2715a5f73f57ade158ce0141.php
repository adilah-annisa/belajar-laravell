<?php $__env->startSection('title', 'List Pelanggan'); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $dataPelanggan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('pelanggan.edit', ['pelanggan' => $item->id])); ?>" class="btn btn-info btn-sm">
...
<?php echo $__env->make('admin.pelanggan.template', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\BPF1_Adilah\belajar-laravel\resources\views/admin/pelanggan/index.blade.php ENDPATH**/ ?>